...
function mancoreg(targetimage, sourceimage)
    ...
    mancoregvar.htoggle_off = uicontrol(fg, ...
        'style', 'radiobutton', ...
        'position', ...
        [470 100 opt.smallFontBoxWidth * 2 opt.largeFontBoxHeight] .* opt.windowScale, ...
        'Value', 1, ...
    ...
    mancoregvar.htoggle_on = uicontrol(fg, ...
        'style', 'radiobutton', ...
        'position', ...
        [530 100 opt.largeFontBoxWidth opt.largeFontBoxHeight] .* opt.windowScale, ...
        'Value', 0, ...
    ...
    mancoregvar.hreset = uicontrol(fg, ...
        'style', 'pushbutton', ...
        'position', [370 75 220 opt.largeFontBoxHeight] .* opt.windowScale, ...
    ...
    mancoregvar.hwrite = uicontrol(fg, 'style', 'pushbutton', ...
        'position', [370 50 220 opt.largeFontBoxHeight] .* opt.windowScale, ...
