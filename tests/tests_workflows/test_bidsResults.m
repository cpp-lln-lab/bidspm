...
function test_bidsResults_basic()
  ...
  rootBasename = ['sub-ctrl02_task-vislocalizer_space-MNI', ...
  ...
  expected = {struct('png', true), ...
              ...
              struct('nidm', struct('modality', 'FMRI', ...
                                    'refspace', 'ixi', ...
                                    'group', struct('nsubj', 1, 'label', 'ctrl02'))) ...
             };

  assertEqual(numel(matlabbatch{1}.spm.stats.results.export), 5);

  assertEqual(matlabbatch{1}.spm.stats.results.export{1}, expected{1});

  assertEqual(matlabbatch{1}.spm.stats.results.export{2}, expected{2});
  ...
  assertEqual(matlabbatch{1}.spm.stats.results.export, expected);
