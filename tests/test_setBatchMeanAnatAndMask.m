...
function test_setBatchMeanAnatAndMaskBasic()
    ...
    %
    expectedBatch{1}.spm.util.imcalc.input{1, :} = fullfile(opt.derivativesDir, ...
        'sub-01', ...
        'ses-01', ...
        'anat', ...
        'wmsub-01_ses-01_T1w.nii');
    expectedBatch{1}.spm.util.imcalc.input{2, :} = fullfile(opt.derivativesDir, ...
        'sub-02', ...
        'ses-01', ...
        'anat', ...
    ...
    expectedBatch{1}.spm.util.imcalc.outdir{:} = pwd;
    expectedBatch{1}.spm.util.imcalc.expression = '(i1+i2)/2';
    
    %
    expectedBatch{2}.spm.util.imcalc.input{1, :} = fullfile(opt.derivativesDir, 'sub-01', ...
        'stats', ...
        'ffx_task-vismotion', ...
        'ffx_space-MNI_FWHM-6', 'mask.nii');
    expectedBatch{2}.spm.util.imcalc.input{2, :} = fullfile(opt.derivativesDir, ...
        'sub-02', ...
        'stats', ...
        'ffx_task-vismotion', ...
        'ffx_space-MNI_FWHM-6', 'mask.nii');
    ...
    expectedBatch{2}.spm.util.imcalc.outdir{:} = pwd;
