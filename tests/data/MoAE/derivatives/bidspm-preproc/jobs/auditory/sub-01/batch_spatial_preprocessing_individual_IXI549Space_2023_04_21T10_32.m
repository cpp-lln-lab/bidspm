...
matlabbatch{8}.spm.spatial.normalise.write.subj.def = {'/home/remi/github/bidspm/tests/data/MoAE/derivatives/bidspm-preproc/sub-01/anat/sub-01_from-T1w_to-IXI549Space_mode-image_xfm.nii'};
...
matlabbatch{9}.spm.spatial.normalise.write.subj.def = {'/home/remi/github/bidspm/tests/data/MoAE/derivatives/bidspm-preproc/sub-01/anat/sub-01_from-T1w_to-IXI549Space_mode-image_xfm.nii'};
matlabbatch{9}.spm.spatial.normalise.write.subj.resample = {'/home/remi/github/bidspm/tests/data/MoAE/derivatives/bidspm-preproc/sub-01/anat/sub-01_space-individual_desc-biascor_T1w.nii'};
matlabbatch{9}.spm.spatial.normalise.write.woptions.vox = [1 1 1];
matlabbatch{10}.spm.spatial.normalise.write.subj.def = {'/home/remi/github/bidspm/tests/data/MoAE/derivatives/bidspm-preproc/sub-01/anat/sub-01_from-T1w_to-IXI549Space_mode-image_xfm.nii'};
matlabbatch{10}.spm.spatial.normalise.write.subj.resample = {'/home/remi/github/bidspm/tests/data/MoAE/derivatives/bidspm-preproc/sub-01/anat/sub-01_space-individual_label-GM_probseg.nii'};
matlabbatch{10}.spm.spatial.normalise.write.woptions.vox = [2 2 2];
matlabbatch{11}.spm.spatial.normalise.write.subj.def = {'/home/remi/github/bidspm/tests/data/MoAE/derivatives/bidspm-preproc/sub-01/anat/sub-01_from-T1w_to-IXI549Space_mode-image_xfm.nii'};
matlabbatch{11}.spm.spatial.normalise.write.subj.resample = {'/home/remi/github/bidspm/tests/data/MoAE/derivatives/bidspm-preproc/sub-01/anat/sub-01_space-individual_label-WM_probseg.nii'};
matlabbatch{11}.spm.spatial.normalise.write.woptions.vox = [2 2 2];
matlabbatch{12}.spm.spatial.normalise.write.subj.def = {'/home/remi/github/bidspm/tests/data/MoAE/derivatives/bidspm-preproc/sub-01/anat/sub-01_from-T1w_to-IXI549Space_mode-image_xfm.nii'};
matlabbatch{12}.spm.spatial.normalise.write.subj.resample = {'/home/remi/github/bidspm/tests/data/MoAE/derivatives/bidspm-preproc/sub-01/anat/sub-01_space-individual_label-CSF_probseg.nii'};
matlabbatch{12}.spm.spatial.normalise.write.woptions.vox = [2 2 2];
matlabbatch{13}.spm.spatial.normalise.write.subj.def = {'/home/remi/github/bidspm/tests/data/MoAE/derivatives/bidspm-preproc/sub-01/anat/sub-01_from-T1w_to-IXI549Space_mode-image_xfm.nii'};
matlabbatch{13}.spm.spatial.normalise.write.subj.resample(1) = cfg_dep('Image Calculator: skullstripped anatomical', substruct('.','val', '{}',{6}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{13}.spm.spatial.normalise.write.woptions.vox = [1 1 1];
matlabbatch{14}.spm.spatial.normalise.write.subj.def = {'/home/remi/github/bidspm/tests/data/MoAE/derivatives/bidspm-preproc/sub-01/anat/sub-01_from-T1w_to-IXI549Space_mode-image_xfm.nii'};
matlabbatch{14}.spm.spatial.normalise.write.subj.resample(1) = cfg_dep('Image Calculator: skullstrip mask', substruct('.','val', '{}',{7}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{14}.spm.spatial.normalise.write.woptions.vox = [1 1 1];
matlabbatch{14}.spm.spatial.normalise.write.woptions.interp = 0;
