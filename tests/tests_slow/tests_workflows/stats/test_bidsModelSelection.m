...
function test_bidsModelSelection_basic()
  ...
  opt.toolbox.MACS.model.files = {fullfile(getTestDataDir(), ...
                                           'models', ...
                                           'model-vismotion_smdl.json')
                                  fullfile(getTestDataDir(), ...
                                           'models', ...
...
function test_bidsModelSelection_missing_space()
  ...
  opt = setOptions('vislocalizer');
  opt = rmfield(opt, 'taskName');
  content = bids.util.jsondecode(fullfile(getTestDataDir(), ...
                                          'models', ...
                                          'model-default_smdl.json'));
  content.Input = rmfield(content.Input, 'space');
  bids.util.jsonwrite(fullfile(getTestDataDir(), ...
                               'models', ...
                               'model-defaultTmp_smdl.json'), ...
                      content);
  ...
  delete(fullfile(getTestDataDir(), ...
                  'models', ...
                  'model-defaultTmp_smdl.json'));
